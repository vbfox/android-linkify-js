 ...
 *  @hide
 */
export const IANA_TOP_LEVEL_DOMAINS: string =
    "(?:"
...
export const IP_ADDRESS_STRING =
...
const USER_INFO = "(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
    + "\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,64}(?:\\:(?:[a-zA-Z0-9\\$\\-\\_"
    + "\\.\\+\\!\\*\\'\\(\\)\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,25})?\\@";

const PORT_NUMBER = "\\:\\d{1,5}";

const PATH_AND_QUERY = "[/\\?](?:(?:[" + LABEL_CHAR
 ...
 */
export const WEB_URL = new RegExp("("
    + "("
    + "(?:" + PROTOCOL + "(?:" + USER_INFO + ")?" + ")?"
    + "(?:" + DOMAIN_NAME_STR + ")"
    + "(?:" + PORT_NUMBER + ")?"
 ...
 */
const STRICT_HOST_NAME = "(?:(?:" + IRI_LABEL + "\\.)+"
    + STRICT_TLD + ")";
 ...
 * {@link #IP_ADDRESS}
 */
const STRICT_DOMAIN_NAME = "(?:" + STRICT_HOST_NAME + "|"
    + IP_ADDRESS_STRING + ")";
